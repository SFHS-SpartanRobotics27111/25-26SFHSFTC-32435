...
public class OmniDrive {
    ...
    private final String LEFT_FRONT_DRIVE = "leftFront";
    private final String LEFT_BACK_DRIVE = "leftBack";
    private final String RIGHT_FRONT_DRIVE = "rightFront";
    private final String RIGHT_BACK_DRIVE = "rightBack";
